...
import com.rs.eis.repository.BeneficiaryRepository;
...
public class FERServiceImpl implements FERService {
	...
	@Override
	public AddBeneficiaryResponse addBeneficiary(Beneficiary beneficiary) {
		AddExpenseResponse response = new AddExpenseResponse();

		Optional<User> userObj = userRepository.findById(beneficiary.getId());

		if (userObj.isPresent()) {

			//beneficiary.setCreated(DateUtil.getCurrentDate("dd-M-yyyy hh:mm:ss"));
			beneficiary = beneficiaryRepository.save(beneficiary);

			response.setExpense(beneficiary);
	...
	@Override
	public EditBeneficiaryResponse editBeneficiary(Beneficiary beneficiary) {
		EditBeneficiaryResponse response = new EditBeneficiaryResponse();

		Optional<Expense> expenseObj = expenseRepository.findById(beneficiary.getId());

		if (expenseObj.isPresent()) {

			//beneficiary.setUpdated(DateUtil.getCurrentDate("dd-M-yyyy hh:mm:ss"));
			beneficiary = expenseRepository.save(beneficiary);
	...
	@Override
	public GetBeneficiaryResponse getBeneficiaryById(int id) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public GetBeneficiaryResponse getById(int id) {
		// TODO Auto-generated method stub
		return null;
	}
