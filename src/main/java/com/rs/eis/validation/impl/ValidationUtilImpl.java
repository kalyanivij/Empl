...
public class ValidationUtilImpl implements ValidationUtil {
	...
	/*
	 * @Override public Set<String> validateRegistrationRequest(RegistrationVO
	 * registrationVO) { Set<String> errorMessages = new HashSet<String>();
	 * 
	 * addError(errorMessages, registrationVO.getFirstName(),
	 * "Please enter FirstName"); addError(errorMessages,
	 * registrationVO.getLastName(), "Please enter LastName");
	 * 
	 ...
	 * 
	 * addError(errorMessages, registrationVO.getUserName(),
	 * "Please enter UserName"); addError(errorMessages,
	 * registrationVO.getPassword(), "Please enter Password");
	 * 
	 * return errorMessages; }
	 * 
	 * public static Set<String> addError(Set<String> errorMessages, String value,
	 * String errorMessage) {
	 * 
	 ...
	 * return errorMessages; }
	 * 
	 * @Override public Set<String> validateGetExpenseRequest(int expenseId) {
	 ...
	 * return errorMessages; }
	 * 
	 * @Override public Set<String> validateDeleteExpenseRequest(int expenseId) {
	 * return validateGetExpenseRequest(expenseId); }
	 * 
	 * @Override public Set<String> validateGetUserRequest(int userId) { return
	 * validateGetExpensesRequest(userId); }
	 * 
	 * @Override public Set<String> validateUpdateUserRequest(UserVO userVO) {
	 * 
	 * Set<String> errorMessages = new HashSet<String>();
	 * 
	 * addError(errorMessages, userVO.getNameVo().getFirstName(),
	 * "Please enter FirstName"); addError(errorMessages,
	 * userVO.getNameVo().getLastName(), "Please enter LastName");
	 * 
	 * addError(errorMessages, userVO.getContactVo().getEmail(),
	 * "Please enter Email"); addError(errorMessages,
	 * userVO.getContactVo().getMobile(), "Please enter Mobile");
	 * 
	 ...
	 */
	@Override
	public Set<String> validateGetDesignationRequest(int id) {
		 ...
		 * 
		 * public static Set<String> addError(Set<String> errorMessages, int value,
		 * String errorMessage) { if (value <= 0) { errorMessages.add(errorMessage); }
		 */
		return null;
	}

	@Override
	public Set<String> validateDeleteDesignationRequest(int id) {

		return validateGetDesignationRequest(id);

	}

	@Override
	public Set<String> validatePutDesignationRequest(int id) {
	...
	@Override
	public Set<String> validateDeleteEmp_DesignationRequest(int id) {
		
		return validatePutDesignationRequest(id);
	}

	@Override
	public Set<String> validateDeleteSalaryRequest(int id) {
		return validateGetDesignationRequest(id);
