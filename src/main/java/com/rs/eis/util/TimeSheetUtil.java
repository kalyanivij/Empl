...
public class TimeSheetUtil {
	...
	public static Timesheet loadTimesheetVOToTimesheet(TimesheetVO timesheetVO) {
		
		Timesheet timesheet = new Timesheet();

		timesheet.setAllocationId(timesheetVO.getAllocationId());
		timesheet.setDay(timesheetVO.getDay());
		timesheet.setDepartmentId(timesheetVO.getDepartmentId());

		timesheet.setEmployeeId(timesheetVO.getEmployeeId());
		timesheet.setInTime(timesheetVO.getInTime());

		timesheet.setOutTime(timesheetVO.getOutTime());
